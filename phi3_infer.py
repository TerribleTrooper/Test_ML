...
SYSTEM_PROMPT = (
    ...
    "- В поле \'label\' укажи ТОЛЬКО основную категорию нарушения. Возможные значения строго:\n"
    "  \'НАСИЛИЕ\', \'НЕНОРМАТИВНАЯ ЛЕКСИКА\', \'СЕКСУАЛЬНЫЙ КОНТЕНТ\', "
    "\'АЛКОГОЛЬ/НАРКОТИКИ\', \'ПУГАЮЩИЙ КОНТЕНТ\', \'БЕЗОПАСНЫЙ КОНТЕНТ\'.\n"
    "- НИКОГДА не ставь возрастной рейтинг (\'0+\', \'6+\', \'12+\', \'16+\', \'18+\') в поле \'label\'.\n"
    "- Если есть несколько нарушений, выбери для \'label\' самое главное (наиболее тяжёлое).\n"
